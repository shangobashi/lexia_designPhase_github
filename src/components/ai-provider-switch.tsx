    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600/30 rounded-xl shadow-lg backdrop-blur-md p-2">
        ...
        >
          ...
          <div className="flex flex-col">
            <span>Groq</span>
            <span className="text-xs text-blue-600">Gratuit • Très Rapide</span>
          </div>
        </DropdownMenuItem>
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-purple-600">Gratuit • Open Source</span>
          </div>
        </DropdownMenuItem>
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-orange-600">Gratuit • Européen</span>
          </div>
        </DropdownMenuItem>
        ...
        >
          ...
          <div className="flex flex-col">
            <span>Mode démo</span>
            <span className="text-xs text-gray-600">Réponses simulées</span>
          </div>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
